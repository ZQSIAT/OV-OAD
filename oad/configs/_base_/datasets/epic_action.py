...
eval_type = "single"
class_type = 'action_perframe' # noun_perframe, verb_perframe, action_perframe
data_root = 'phdd:s3://epic_extc_feats_4fps/CLIP_ViT_B_16_768/'
anno_root = '/mnt/petrelfs/heyinan/00_zqs/data/epic'
